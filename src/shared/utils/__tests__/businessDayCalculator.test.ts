import {
    ...
    describe ('businessDayCalculator', () => {
        describe ('isBusinessDay', () => {
            ...
            it ('should reutrn false for know South african holidays', () => {
    ...
    describe ('addBusinessDays', () => {
      it ('should add days within a standard week without hittng weekends', () => {
      ...
      it ('should skip over public hoildays cleanly', () => {
    ...
    it('should enclude weekend and public holidays from the toatl counts', () => {
        const start = new Date ('2026-04-02');
...
describe ('calculateCurePeriodDeadline', () => {
    it ('should add exactly 20 business day to a regular start date', () => {
    ...
    it ('should accept a string date respenstation input semlessly', () => {
